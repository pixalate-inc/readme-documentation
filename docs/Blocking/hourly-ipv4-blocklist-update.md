---
title: "Hourly IPv4 Blocklist Update"
excerpt: "Effective November 17, 2025, Pixalate introduced hourly updates to our IPv4 blocklist, delivering enhanced precision in Sophisticated Invalid Traffic (SIVT) detection with an optimized datafeed architecture for faster ingestion and processing."
deprecated: false
hidden: false
metadata:
  title: ''
...
**Our IPv4 blocklist now refreshes every hour (enhanced from twice daily), enabling faster response to emerging invalid traffic patterns and significantly reducing exposure windows to new IVT threats.
