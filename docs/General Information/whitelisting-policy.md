...
For whitelisting requests involving Server-side Ad Insertion (SSAI) Server IP addresses, requests should be funneled via this [form](https://docs.google.com/forms/d/e/1FAIpQLScKFjd7InnpFZ2u_C-B9AKo7QtwWwoWP4Vnrn-TKuSQyTmzsA/viewform) which is periodically reviewed by Pixalate staff and translated into internal tickets for further investigation. 
