---
title: "Glossary of MRT Tooltips"
excerpt: "The tooltips and definitions shown below are in the Media Ratings Terminal (MRT) and current as of March 2025."
deprecated: false
hidden: false
metadata:
  title: ''
...
Risk Score | Pixalate's unique overall advertising risk score based on blended risk factors including brand safety, invalid traffic and ad inventory.  
...
Est. SSAI | The percentage of traffic observed to utilize server-side-ad-insertion (SSAI) integrations for ad/ad content delivery to the end user.  
Est. Transparent SSAI | SSAI tracked impressions that come from proxies passing X-Device-User-Agent headers for more transparency.  
Brand Safety Risk | Risk factors to advertiser Brand Safety broken down by both in-app content such as images, and descriptive text about the app.  
...
SECTION: APP SPOOFING |   
App Spoofing | Traffic where the app identifier (e.g. bundleId) reported to the exchange does not match the characteristics of the app detected by Pixalate.  
Apparent Victim of Spoofing | Indicates if the app has a significant amount of impressions detected that may be misrepresented in advertising transactions.  
...
Impression Volume Obfuscation | The traffic behind this app is associated with potential backround activity that fires multiple impressions at once.  
Device Obfuscation | The traffic behind this app comes from oobfuscated device identifiers.  
User Agent Obfuscation | The User Agent (UA) detected by Pixalate does not match the UA passed in the bid request.  
SECTION: APP DETAILS |   
...
Keywords | Search terms and keywords typically associated to the app.  
App's Privacy Policy | Indicates whether an app-specific privacy policy is maintained. Apps which do not maintain a privacy policy may be of higher risk to advertisers and sellers.  
Revenue Sources | The primary source of revenue (e.g., ads, in-app subscriptions, etc.), as cited within the app store.  
CVAA Compliant | Indicates whether the app is in compliance with the FCC's Communications and Video Accessibility Act (CVAA) Standards. Compliance with CVAA Standards is required across premium OTT/CTV Video on Demand (VoD) content (e.g., TVoD), Subscription VoD (SVoD) content, and content delivered via traditional cable outlets.  
App Age | The amount of time the app has been listed within the app store. Apps which have been listed for an extended period of time may present less risk than those recently published.  
Published Date | The date of original publication within the app store.  
Bundle ID | The unique textual identifier of the app within the app store. For Roku, this is oftentimes referred to as the Channel ID.  
SECTION: DEVELOPER OVERVIEW |   
Developer Overview | Essential information about the app's developer.  
Name | The business name of the app's developer.  
Total Apps | The total number apps available from the developer.  
WHOIS Info Hidden | Businesses with privately registered anonymous domains are flagged as high risk.  
Terms and Conditions | Businesses without published terms and conditions on their website are flagged as high risk to advertisers and sellers.  
Privacy Policy | Indicates the presence of a privacy policy on the app's publisher or developer website. Businesses without a privacy policy on their website are flagged as high risk to advertisers and sellers.  
...
Brand Safety | The combined risk to advertiser Brand Safety, from all risk factors detailed in the Brand Safety Risk section, based on both descriptive text and content analysis.  
Description Risk | The overall Brand Safety risk to advertisers based on textual analysis of the app's descriptive text. App descriptive text is processed through natural language algorithms and comprehensive categorical dictionaries to predict the advertiser brand safety risk.  
Advisories | The risk to brand safety derived from the app's content advisories  
...
IVT Free Users | The percentage of the app's individual user-base not responsible for presence of invalid traffic.  
Est. Daily Reach | Est. Daily Reach  
Est. Monthly Reach | Est. Monthly Reach  
...
Reseller | The contribution of resellers (e.g., intermediaries, etc.) to programmatic ad impressions sold on the app.  
Unauthorized Seller | The contribution of unauthorized sellers (based on exclusion from App-Ads.Txt file) to programmatic ad impressions sold on the app.  
...
SECTION: INVENTORY |   
Inventory | The estimated volume of ad impressions offered by the app over programmatic advertising platforms and exchanges.  
...
Facebook | Low social media engagment on Facebook can be a risk factor  
LinkedIn | Low social media engagment on LinkedIn can be a risk factor  
Twitter | Low social media engagment on Twitter can be a risk factor  
SECTION: RANKINGS BY COUNTRY |   
Rankings by Country | Market Share and Reach Rankings by Country  
Global Reach Ranking By Country | Reach Ranking by Country  
Global Market Share Ranking by Country | Market Share Ranking by Country  
...
**Tooltip/Label** | **Description**  
---|---  
SECTION: IVT OVERVIEW |   
IVT Overview | The overall percentage of Invalid Traffic (IVT) associated with advertising transactions for the domain. All IVT calculations are derived from standardized definitions of invalid traffic maintained by the Media Rating Council, Inc. (MRC), Interactive Advertising Bureau (IAB), and Trustworthy Accountability Group (TAG).  
SECTION: RISK OVERVIEW |   
Risk Overview | Pixalate's unique advertising risk assessment based on blended risk factors including brand safety, invalid traffic and ad inventory  
Desktop | Blended advertiser risk assessment for the Domain on Desktops by global business region  
Mobile | Blended advertiser risk assessment for the Domain on Mobile Phones by global business region  
Pixalate Advisories | Pixalate's unique listing of key advisories for a particular domain based on risk factors (e.g., ads.txt, privacy terms, etc.).  
SECTION: MADE FOR ADVERTISING (MFA) RISK |   
MFA Risk | Pixalate's assessment of the likelihood of the website being deemed MFA, based on Pixalate's MFA detection methodology.  
Ad Refresh Rate | Number of ad impressions presented to a user, per minute.  
Ad Density | Number of ad placements presented to a user, per minute.  
Social Traffic Rate | Based on the amount of traffic sourced via social media.  
Paid Traffic Rate | Based on the amount of traffic sourced via paid (ad) sources  
SECTION: SITE RISK |   
WHOIS Info Hidden | Private Domains are those that are registered as anonymous in the Whois site registration data  
Corporate Email | Indicates if the app has a significant amount of impressions detected that may be misrepresented in advertising transactions.  
SECTION: BRAND SAFETY RISK |   
Brand Safety Risk | Risk levels for our brand safety categories are assessed at the homepage (root domain) level  
SECTION: SOCIAL MEDIA ENGAGEMENT |   
Social Media Engagement | Active engagement levels for various social platforms  
SECTION: INVALID TRAFFIC (IVT) |   
GIVT% | General Invalid Traffic - Deterministically judged to be non-human traffic; high to very high risk  
SIVT% | Sophisticated Invalid Traffic - Probabilistically judged to be non-human traffic; moderate to high risk traffic  
SECTION: VIEWABILITY |   
Global Viewability | The average viewability percentage of valid traffic for all ad sizes and traffic types in the app  
SECTION: REFERRAL TRAFFIC |   
Social | The percent of this domain's traffic that comes from social media  
Direct | The percent of this domain's traffic that comes from a user directly typing the web address in their browser or clicking an existing bookmark  
Search | The percent of this domain's traffic that comes from search engines  
Discovery | The percent of this domain's traffic that comes from widgets or links to this site from other websites  
Email | The percent of this domain's traffic that comes from email  
Go back to the top
...
**Tooltip/Label** | **Description**  
---|---  
SELECTION: Connected TV (Roku, Fire TV, Samsung, tvOS) |   
MFA Risk | Pixalate's assessment of the risk of the app being deemed MFA, based on Pixalate's MFA detection methodology  
SELECTION: Mobile (Google Play. Apple App Store) |   
Est. Inventory | The estimated number of monthly impressions this app makes available programmatically.  
Viewability | The average viewability for all display ad impressions in the app  
Est. IVT | Percentage of Invalid Traffic associated with advertising transactions for the app  
Blocklisted | The app has been placed on a Pixalate high risk blocklist - contact sales for subscription details  
MFA Risk | Pixalate's assessment of the risk of the app being deemed MFA, based on Pixalate's MFA detection methodology  
Brand Safety Risk | Risk factors to advertiser Brand Safety broken down by both in-app content such as images, and descriptive text about the app  
Incentivized App | Indicates if the app is an incentivized app  
User Generated Content | Indicates if the app has user generated content  
SELECTION: Domains |   
Viewability | The average viewability percentage of valid traffic for all ad sizes and traffic types in the domain  
IVT | The total percentage of non-human traffic measured on the domain  
