...
Pixalate analyzes 50+ billion monthly global advertising transactions to rank **580+ sellers** across **140+ countries**.   
 ...
 _Learn about the STI’s ranking criteria.  
_
...
Reports are available **by quarter** and **by country**.
  ...
  * _**Note:** Regional reports were available prior to Q2 2024._

![Screen Shot 2024-09-13 at 9.40.16 AM](https://2364596.fs1.hubspotusercontent-na1.net/hubfs/2364596/Screen%20Shot%202024-09-13%20at%209.40.16%20AM.png)
...
_Learn about the_ _STI’s ranking criteria_ _._  
...
Reports are available **by quarter** and **by country**.
  ...
  * **_Note:_**_Regional reports were available prior to Q2 2024._

![Screen Shot 2024-09-13 at 9.39.56 AM](https://2364596.fs1.hubspotusercontent-na1.net/hubfs/2364596/Screen%20Shot%202024-09-13%20at%209.39.56%20AM.png)
...
Reports are available **by quarter** and **by country**.
  ...
  * **_Note:_**_Regional reports were available prior to Q2 2024_

![Screen Shot 2024-09-24 at 9.55.58 AM](https://2364596.fs1.hubspotusercontent-na1.net/hubfs/2364596/Screen%20Shot%202024-09-24%20at%209.55.58%20AM.png)
...
_How to interpret_ _Bundle Integrity Scores_ _._

#### **Invalid Traffic (IVT) Score**

Indicates the share of a seller’s impressions that are [designated as IVT](https://www.pixalate.com/knowledgebase/reported-invalid-traffic-ivt-types). For the CTV Seller Trust Index, the “IVT Score” accounts for both GIVT and SIVT.
...
_How to interpret_ _Invalid Traffic (IVT) Scores_ _._

#### **Made for Advertising (MFA) Risk Score**

Indicates the level of [Made For Advertising (MFA)](https://www.pixalate.com/knowledgebase/mfa-made-for-advertising-definitions) traffic associated with a seller. MFA Risk Scores are based on two factors:

  1. The **percentage** of a seller's traffic classified as MFA.
  2. A seller's **share** of overall MFA traffic within a particular country.

_How to interpret_ _MFA Risk Scores_ _._

#### **Market Share Score**

A seller’s share of impressions within a particular country, inclusive of only IVT-free impressions.

_How to interpret_ _Market Share Scores_ _._
...
_How to interpret_ _SCO Verification Scores_ _._

#### **Supply Path Optimization (SPO) Score**

Uses the SupplyChain Object (SCO) to determine the share of ad impressions within a country, where the seller is identified as an **authorized** direct seller as per publishers’ ads.txt or app-ads.txt files and the SCO object.

_How to interpret_ _SPO Scores_ _._

#### **Delisted App Risk Score**

Measures the volume of a seller’s impressions on apps delisted from the Apple App Store and Google Play Store, as well as fraudulent, malformed, and/or unidentified mobile bundle IDs.   
  
 _How to interpret Delisted App Risk Score_
...
[_Learn more about_ _malformed Bundle IDs_ _._](https://www.pixalate.com/blog/q2-2024-malformed-fraudulent-ctv-bundle-ids-risk-report)
...
_For a complete list of reported IVT types,_[_please refer to this article_](https://www.pixalate.com/knowledgebase/reported-invalid-traffic-ivt-types) _._
...
_For more information on Pixalate's MFA solutions and background,_[_please refer to this article_](https://www.pixalate.com/knowledgebase/made-for-advertising-mfa) _._
...
#### **Interpreting the Delisted App Risk Score**

    * The Delisted App Risk Score assesses the overall traffic volume of each seller on delisted apps. In general, apps can be delisted for various reasons, including publisher level fraud, malware, adware, availability of backdoors for fraudsters to leverage bad SDKs, or simply because the developer decided to delist an app. In addition, it is also possible for an app to be delisted for other reasons such as copyright violations.
    * A low Delisted App Risk Score indicates that a seller has a higher likelihood to sell traffic on riskier apps not currently listed on an established app store.
    * For more information on Pixalate's Delisted App blocking solutions, [please refer to this article](https://www.pixalate.com/knowledgebase/delisted-from-the-app-store-defase-block-list)
